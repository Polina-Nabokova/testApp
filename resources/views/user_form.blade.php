...
@section('content')
    <div class="container">
        <div class="row  mt-4">
            <div class="col-1"><a href="{{ route('users-list') }}" class="btn btn-primary">Back</a></div>
            <div class="col-10"><span class="h3">Create new user</span></div>
        </div>
        <div class="row">
            <div class="col-1"></div>
            <div class="col-6">
            <form action="{{ route('user-create') }}" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    <label for="name">Name <span>* @error('name') {{ $message }} @enderror</span></label>
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="input-field">
                        ...
                        <div class="choose-wrap row">
                            ...
                            <span class="select-btn col-4">Select File</span>
                        </div>
                    </div>
                </div>
